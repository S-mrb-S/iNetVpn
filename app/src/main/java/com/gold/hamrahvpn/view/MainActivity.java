package com.gold.hamrahvpn.view;
...
import com.gold.hamrahvpn.adapter.ServerListRVAdapter;
...
import com.gold.hamrahvpn.util.Utils;
...
public class MainActivity extends AppCompatActivity implements NavItemClickListener {
    ...
    private ArrayList getServerList() {
        ...
        servers.add(new Server("Mehrab Vpn tcp",
                Utils.getImgURL(R.drawable.svpn__country_flag),
                "client-all-tcp.ovpn",
                "xerror438t",
                "64"
        ));
         servers.add(new Server("Mehrab Vpn udp",
                Utils.getImgURL(R.drawable.svpn__country_flag),
                "client-all-udp.ovpn",
                "xerror438t",
                "64"
