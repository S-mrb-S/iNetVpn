...
import com.gold.hamrahvpn.databinding.ItemQrcodeBinding
import com.gold.hamrahvpn.databinding.ItemRecyclerFooterBinding
import com.gold.hamrahvpn.databinding.ItemRecyclerV2rayMainBinding
...
class MainRecyclerV2rayAdapter(val activity: MainSettingsV2ray) : RecyclerView.Adapter<MainRecyclerV2rayAdapter.BaseViewHolder>()
    ...
    private var mActivity: MainSettingsV2ray = activity
...
//            }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        return when (viewType) {
            VIEW_TYPE_ITEM ->
                MainViewHolder(ItemRecyclerV2rayMainBinding.inflate(LayoutInflater.from(parent.context), parent, false))
            else ->
    ...
    class MainViewHolder(val itemMainBinding: ItemRecyclerV2rayMainBinding) :
