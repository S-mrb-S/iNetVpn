...
import com.xray.lite.AppConfig.PREF_ALLOW_INSECURE
...
import com.xray.lite.dto.V2rayConfig.Companion.DEFAULT_PORT
...
import com.xray.lite.util.MmkvManager.ID_MAIN
import com.xray.lite.util.MmkvManager.KEY_SELECTED_SERVER
import com.xray.lite.util.Utils
import com.xray.lite.util.Utils.getIpv6Address

class ServerAngActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sp_network?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                val adapter =
                    ArrayAdapter(this@ServerAngActivity, android.R.layout.simple_spinner_item, types)
