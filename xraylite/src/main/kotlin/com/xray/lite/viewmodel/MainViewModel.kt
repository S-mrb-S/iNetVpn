...
import com.xray.lite.InitV2rayModule.MainApplication
import com.xray.lite.R
import com.xray.lite.databinding.DialogConfigFilterBinding
...
//    register
    fun startListenBroadcast() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            MainApplication.registerReceiver(
                mMsgReceiver,
    ...
    override fun onCleared() {
        MainApplication.unregisterReceiver(mMsgReceiver)
    ...
    fun testAllTcping() {
        ...
        MainApplication.toast(R.string.connection_test_testing)
...
//            }.show()
    ...
    fun removeDuplicateServer() {
        ...
        reloadServerList()
        MainApplication.toast(
            MainApplication.getString(
        ...
        override fun onReceive(ctx: Context?, intent: Intent?) {
            when (intent?.getIntExtra("key", 0)) {
                ...
                AppConfig.MSG_STATE_START_SUCCESS -> {
                    MainApplication.toast(R.string.toast_services_success)
                    isRunning.value = true
                }

                AppConfig.MSG_STATE_START_FAILURE -> {
                    MainApplication.toast(R.string.toast_services_failure)
                    isRunning.value = false
                }
